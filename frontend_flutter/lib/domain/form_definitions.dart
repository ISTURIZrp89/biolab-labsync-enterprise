    ...
    'sections': [
      {
        ...
        'fields': [
          ...
          {'key': 'hora_inicio', 'label': 'Hora Inicio', 'type': 'time', 'required': true},
          {'key': 'hora_fin', 'label': 'Hora Fin', 'type': 'time', 'required': true},
          {'key': 'responsable', 'label': 'Elaborado por', 'type': 'text', 'required': true},
          ...
          {'key': 'actividad', 'label': 'Descripcion de la Actividad', 'type': 'text', 'multiline': true, 'required': true},
          {'key': 'observaciones', 'label': 'Observaciones / Resultados', 'type': 'text', 'multiline': true},
