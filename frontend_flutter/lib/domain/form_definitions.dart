  ...
  'sections': [
    {
      ...
      'activities_table': {
        ...
        'columns': [
          ...
          {'key': 'volumen', 'label': 'Volumen (CC)', 'type': 'select', 'options': ['5CC', '3CC', '2CC', '1CC', '10CC'], 'width': 100},
          {'key': 'uso', 'label': 'Uso Terapeutico', 'type': 'select', 'options': ['SISTEMICO', 'ARTICULAR RODILLA', 'ARTICULAR CADERA', 'ARTICULAR TOBILLO', 'ARTICULAR LUMBAR', 'INTRAVENOSO', 'TOPICO'], 'width': 140},
          {'key': 'tejido', 'label': 'Tipo de Tejido', 'type': 'select', 'options': ['PLACENTA', 'TEJIDO ADIPOSO', 'PULPA', 'ENDOMETRIO', 'MEMBRANA', 'GW', 'AUTOLOGAS', 'ALOGENICAS', 'EXOSOMAS', 'CORDON UMBILICAL'], 'width': 140},
          {'key': 'paciente', 'label': 'Paciente', 'type': 'text', 'width': 180},
          {'key': 'enviado_a', 'label': 'Enviado a', 'type': 'select', 'options': ['INMUNOTERAPIA', 'QUANTUM', 'HOSPITAL', 'CLINICA PRIVADA', 'OTRO'], 'width': 140},
    ...
    {
      'key': 'frascos_incubadoras',
      'label': 'Control de Frascos en Incubadoras',
      'type': 'daily_log',
      'general_fields': [
        {'key': 'fecha', 'label': 'Fecha', 'type': 'date', 'required': true},
        {'key': 'responsable', 'label': 'Responsable', 'type': 'autofill', 'required': true},
      ...
      'activities_table': {
        'label': 'Frascos de Cultivo en Incubadoras',
        'key': 'frascos',
        'columns': [
          {'key': 'incubadora', 'label': 'Incubadora', 'type': 'select', 'dynamic': 'Incubadoras', 'width': 120},
          {'key': 'tipo_frasco', 'label': 'Tipo Frasco', 'type': 'select', 'options': ['T25', 'T75', 'T175', 'T300'], 'width': 90},
          {'key': 'tipo_celular', 'label': 'Tipo Celular', 'type': 'select', 'options': ['MSC', 'NK', 'FIBROBLASTOS', 'CONDROCITOS', 'ADIPOCITOS', 'IPSC', 'EXOSOMAS'], 'width': 120},
          {'key': 'pase', 'label': 'Pase No.', 'type': 'number', 'width': 70},
          {'key': 'cantidad', 'label': 'Cantidad', 'type': 'number', 'width': 80},
          {'key': 'confluencia', 'label': 'Confluencia %', 'type': 'number', 'width': 90},
          {'key': 'fecha_siembra', 'label': 'Fecha Siembra', 'type': 'date', 'width': 100},
          {'key': 'proximo_cambio', 'label': 'Prox. Cambio/Pase', 'type': 'date', 'width': 110},
          {'key': 'medio', 'label': 'Medio', 'type': 'text', 'width': 130},
          {'key': 'observaciones', 'label': 'Observaciones', 'type': 'text', 'width': 200},
        ],
      },
      'fields': [],
