...
final List<CsvModuleDetector> csvModuleDetectors = [
  ...
  CsvModuleDetector(
    moduleKey: 'bitacora',
    moduleName: 'Bitacora General',
    sectionKey: 'actividades',
    minScore: 0.25,
    mappings: [
      CsvFieldMapping(module: 'bitacora', section: 'actividades', fieldKey: 'fecha', columnPattern: r'(?i)fecha|date'),
      CsvFieldMapping(module: 'bitacora', section: 'actividades', fieldKey: 'hora_inicio', columnPattern: r'(?i)hora.*inicio|hora ini'),
      CsvFieldMapping(module: 'bitacora', section: 'actividades', fieldKey: 'hora_fin', columnPattern: r'(?i)hora.*fin|hora fin'),
      CsvFieldMapping(module: 'bitacora', section: 'actividades', fieldKey: 'responsable', columnPattern: r'(?i)responsable|elaborado|nombre'),
      CsvFieldMapping(module: 'bitacora', section: 'actividades', fieldKey: 'actividad', columnPattern: r'(?i)actividad'),
      CsvFieldMapping(module: 'bitacora', section: 'actividades', fieldKey: 'descripcion', columnPattern: r'(?i)descripcion|descripción'),
      CsvFieldMapping(module: 'bitacora', section: 'actividades', fieldKey: 'cajas', columnPattern: r'(?i)cajas'),
      CsvFieldMapping(module: 'bitacora', section: 'actividades', fieldKey: 'tipo_tejido', columnPattern: r'(?i)tejido|tipo tejido'),
      CsvFieldMapping(module: 'bitacora', section: 'actividades', fieldKey: 'viales', columnPattern: r'(?i)viales'),
      CsvFieldMapping(module: 'bitacora', section: 'actividades', fieldKey: 'misid', columnPattern: r'(?i)misid'),
      CsvFieldMapping(module: 'bitacora', section: 'actividades', fieldKey: 'millones', columnPattern: r'(?i)mill.*cel|millones|celulas|células'),
      CsvFieldMapping(module: 'bitacora', section: 'actividades', fieldKey: 'observaciones', columnPattern: r'(?i)observa|notas|comentarios'),
      CsvFieldMapping(module: 'bitacora', section: 'actividades', fieldKey: 'incidencias', columnPattern: r'(?i)incidencias'),
    ],
  ),
  CsvModuleDetector(
